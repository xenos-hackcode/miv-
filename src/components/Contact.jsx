...
function buildWhatsAppMessage(form, pastorName) {
  return encodeURIComponent(
    ...
    `${form.message}\n\n` +
    `━━━━━━━━━━━━━━━━━━\n` +
    `🏛️ *The Men of Issachar Vision (MIV)*\n` +
        ...
        >
          ...
          <div>
            ...
            <div style={{
              ...
              <iframe
                title="The Men of Issachar Vision — Gorgie Memorial Hall"
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.6, fontStyle: 'italic' }}>
                      🏛️ The Men of Issachar Vision (MIV) · Gorgie Memorial Hall, Edinburgh · Sent from MIV website
                    </div>
                  </div>
                </div>
